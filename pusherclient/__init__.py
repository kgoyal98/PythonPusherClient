...
class Pusher(object):
    ...
    def __init__(self, key, host, secure=True, secret=None, user_data=None, log_level=logging.INFO, daemon=True, port=None, reconnect_interval=10):
        self.key = key
        self.host = host
        self.secret = secret
        ...
        self.url = self._build_url(key, host, secure, port)
    ...
    @classmethod
    def _build_url(cls, key, host, secure, port=None):
